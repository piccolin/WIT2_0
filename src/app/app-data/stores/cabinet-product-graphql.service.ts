...
} from '../../../graphql/queries'; // Adjust path to your codegen output (e.g., src/graphql/queries.ts)
...
} from '../../../graphql/mutations'; // Adjust path to your codegen output (e.g., src/graphql/mutations.ts)
...
} from '../../../graphql/subscriptions'; // Adjust path to your codegen output (e.g., src/graphql/subscriptions.ts)

import { BaseGraphqlService } from './base-graphql.service'; // Adjust path to your base service
